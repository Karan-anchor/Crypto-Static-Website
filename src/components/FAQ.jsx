...
const FAQ = () => {
    ...
    px-4 sm:px-6 lg:px-8 relative'>
            ...
            <div className="max-w-4xl mx-auto transform hover:scale-[1.005] transition-all duration-300 relative z-10">
                <h2 className="text-4xl md:text-5xl lg:text-6xl xl:text-7xl font-bold mb-8 md:mb-12 lg:mb-16 font-['Montserrat'] tracking-tighter text-center">
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-cyan-400 to-blue-500">
                        Frequently
                    </span>
                    <span className="bg-clip-text text-transparent bg-gradient-to-r from-purple-400 to-pink-500 md:ml-4 block md:inline mt-2 md:mt-0">
                        Asked Questions
                    </span>
                </h2>
                ...
                <div className="space-y-4 md:space-y-6">
                    {faqItems.map((item, index) => (
                        <div key={index} className={`relative overflow-hidden rounded-xl md:rounded-2xl"
                        p-1 transiton-all duration-300 ${activeIndex === index ? 'bg-gradient-to-r from-purple-500 to-pink-500'
               ...
               bg-purple-500/10 rounded-full blur-3xl"
                    />
                    <div
                        className="absolute -bottom-20 -left-20 w-64 h-64 md:w-96 md:h-96
