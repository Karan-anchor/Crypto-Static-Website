...
const ContactUs = () => {
  ...
  return (
    ...
    via-black to-gray-900 p-6 relative overflow-hidden'>
      ...
      {/* {Main Content} */}
      <div className={`relative bg-gradient-to-br from-gray-800 to-gray-900 rounded-2xl shadow-2xl transition-all
            duration-500 ${isExpanded ? 'w-[600px]' : 'w-[500px]'}`}
        onFocus={handleFocus}
        onBlur={handleBlur}>
        <div className='p-8 space-y-6'>
          {/* {Animate Headder} */}
          <div className='text-center group'>
            <h1 className='text-4xl font-bold bg-gradient-to-r from-purple-400 via-pink-300 to-blue-400
                  bg-clip-text text-transparent inline-block '>
              Get in Touch
            </h1>
            <div className='h-1 bg-gradient-to-r from-purple-500 to-blue-500 w-20 mx-auto
            ...
            <form onSubmit={handleSubmit} className="space-y-6">
              ...
              <button
                ...
                className="w-full py-3 bg-gradient-to-r from-purple-600 to-blue-500 hover:from-blue-600 hover:to-purple-600 text-white font-bold rounded-lg flex items-center justify-center space-x-2 transition-all hover:scale-[1.02] shadow-lg hover:shadow-purple-500/30"
              >
