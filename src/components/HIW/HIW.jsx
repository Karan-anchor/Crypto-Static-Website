...
const HIW = () => {
  return (
    <section className='bg-gradient-to-r from-gray-900 via-black to-gray-900 py-24 px-4  relative
    text-white overflow-hidden'>
      ...
      <div className='max-w-7xl mx-auto text-center relative z-10'>
        ...
        <p className='max-w-2xl mx-auto text-gray-300 text-xl md:text-2xl mb-16 font-lato leadding-relaxed'>
          Transforming complexity into seamless digita experiences through innovative solutions
        </p>
            ...
            >
              ...
              <div className="relative bg-gray-900/80 rounded-3xl p-8 shadow-2xl border border-gray-700/50 backdrop-blur-xl transform-style-preserve-3d">
                ...
                <div className='relative z-20'>
                  <div className='mv-8 relative inline-block'>
                    <img src={img} alt={`Step ${index + 1}`}
                      className='w-32 h-32 md:w-48 md:h-48 objet-contain animate-float' />

                    <div className='absolute inset-0 bg-gradient-to-r from-cyan-500 
                    to-purple-600 roundded-full opacity-20 blur-2xl -z-10'/>
                  </div>
                  ...
                  <p className='text-gray-300 font-late text-lg leading-relaxed'>
                    {
                      [
                ...
                transition-opacity duration-500'>
                  <div className='absolute -inset-2 bg-gradient-to-r from-cyan-500/30
                  to-purple-500/30 rounded-3xl animate-pulse-slow'>
                  </div>
